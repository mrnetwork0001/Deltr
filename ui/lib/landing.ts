...
// "Launch app" is always the same-origin dashboard: FastAPI serves it next to the API on the
// VPS and locally, and on Vercel the vercel.json rewrites proxy /api and /mcp to the VPS.
